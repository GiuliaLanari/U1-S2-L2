...
const num1 = 2;
const num2 = 10;
console.log("num1 è maggiore di num2?", num1 > num2);
...
console.log("not egual", num3 != 5);

/* ESERCIZIO 3
  Scrivi un algoritmo che mostri "divisibile per 5" in console se un numero fornito è perfettamente divisibile per 5 (suggerimento: usa l'operatore modulo)
*/
const num4 = 25;
console.log("num4 è perfetamente divisibile per 5?", num4 % 5);
...
console.log("num5 più num6 è uguale a 8?", num5 + num6 === 8);
console.log("num5 meno num6 è uguale a 8?", num5 - num6 === 8);
